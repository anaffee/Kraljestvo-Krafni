    ...
    <div class="container" id="galerija">
        ...
        <div class="gallery">
            <div class="mySlides">
                ...
                <img src="./img//galerija/cokolada.jpg">
            </div>

            <div class="mySlides">
                <div class="numbertext">2 / 6</div>
                <img src="./img//galerija/slika1.webp">
            </div>

            <div class="mySlides">
                <div class="numbertext">3 / 6</div>
                <img src="./img//galerija/slika2.webp">
            </div>

            <div class="mySlides">
                <div class="numbertext">4 / 6</div>
                <img src="./img//galerija/slika3.webp">
            </div>

            <div class="mySlides">
                <div class="numbertext">5 / 6</div>
                <img src="./img//galerija/slika4.jpg">
            </div>

            <div class="mySlides">
                <div class="numbertext">6 / 6</div>
                <img src="./img//galerija/slika5.webp">
            </div>

            <div class="mySlides">
                <div class="numbertext">6 / 6</div>
                <img src="./img//galerija/slika7.jpg">
            </div>

            <div class="mySlides">
                <div class="numbertext">6 / 6</div>
                <img src="./img//galerija/slika8.avif">
            </div>
        ...
        <div class="galleryTxt">
            <div class="galleryMain">
                <h1>Zagrizi užitak!</h1>
            </div>
            <p>
                Svaka krafna u Kraljevstvu Krafni je malo remek-delo – mekana, vazdušasta i bogato punjena. Uživajte u pogledu na naše slatke kreacije, prepustite se bojama i oblicima koji mame osmeh, i zamislite ukus svakog zalogaja – jer verujemo da je svaka krafna poseban trenutak sreće! 🍩💛
            </p>
        </div>
